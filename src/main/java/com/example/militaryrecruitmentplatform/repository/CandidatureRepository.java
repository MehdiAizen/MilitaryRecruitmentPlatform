...
public interface CandidatureRepository extends JpaRepository<Candidature, Long> {
     ...
     */
    List<Candidature> findByUniteChoisieNom(String nomUnite);
    /**
     ...
     */
    @Query("SELECT COUNT(c) FROM Candidature c WHERE c.uniteChoisie.nom = :nomUnite")
    long countByUniteNom(@Param("nomUnite") String nomUnite);
    /**
